function stop = LaskosExe2Fun2(data)

    %Same function as LaskosExe1Fun2
    ...
    first wave is defined as the index(in the dataset) of the last non zero 
    value of the group obtained.
    %}
